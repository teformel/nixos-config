# NixOS Configuration (Niri + Noctalia 专属大一统分支)

这是我的个人 NixOS 系统配置仓库的 **`niri+noctalia` 分支**。在这个平行宇宙中，它提供了极其硬核、极具现代感的 **Niri (Wayland 滚动窗口管理器) + Noctalia Shell** 桌面生态体验。
...
| :--- | :--- |
| **窗口管理器** | Niri |
| **桌面交互环境** | Noctalia Shell (状态栏/通知中心) |
| **应用启动器** | Fuzzel |
| **终端环境** | Alacritty + Fish |
...
└── 📂 modules                 # 模块库
    ...
    └── 📄 desktop.nix         # 🎨 Niri+Noctalia 专属桌面环境配置
```
